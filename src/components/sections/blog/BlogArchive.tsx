...
const posts: Post[] = [
  ...
  },
  {
    ...
    title: "The offline problem no land-ops platform actually solved",
    excerpt: "Why we built Oxland's Android app to work without signal, and what that changed for surveyors in tier-3 districts.",
  ...
  },
  {
    slug: "#",
    category: "Litigation",
    categoryPalette: "bg-rose-50 text-rose-600",
    title: "Litigation as a first-class object, not a folder of PDFs",
    excerpt: "How we index court orders, hearings and cause lists per parcel — and why that matters when an audit lands.",
    author: "Suresh Verma",
    authorInitials: "SV",
    date: "28 Feb 2026",
    readTime: "7 min read",
  ...
  },
  {
    ...
    category: "GIS",
    categoryPalette: "bg-brand-indigo/10 text-brand-indigo",
    title: "Cadastre snapping without losing your mind",
    excerpt: "The engineering behind polygon-to-cadastre snap that survives contact with real state GIS layers.",
    author: "Naveen Menon",
    authorInitials: "NM",
    date: "20 Feb 2026",
    readTime: "9 min read",
  ...
  },
  {
    slug: "#",
    category: "R&R",
    categoryPalette: "bg-pink-50 text-pink-600",
    title: "Family-wise R&R tracking: getting the software out of the way",
    excerpt: "What we learned building a beneficiary-first R&R module — and why it looks nothing like most compensation trackers.",
  ...
  },
  {
    slug: "#",
    category: "OCR",
    categoryPalette: "bg-violet-50 text-violet-600",
    title: "10-language OCR: why English-first pipelines fail India",
    excerpt: "A deep dive into the OCR stack that reads RoRs in Marathi and court orders in Hindi without hand-holding.",
    author: "Ravi Kaul",
    authorInitials: "RK",
    date: "04 Feb 2026",
  ...
  },
  {
    ...
    category: "Field ops",
    categoryPalette: "bg-emerald-50 text-emerald-600",
    title: "The drone-to-parcel pipeline in 900 lines of code",
    excerpt: "How a DGCA-licensed drone flight becomes a parcel-linked orthomosaic in Oxland — architecture, gotchas and pricing.",
    author: "Meera Iyer",
    authorInitials: "MI",
    date: "26 Jan 2026",
...
const CATEGORIES = ["All", "Company", "Field ops", "Litigation", "GIS", "R&R", "OCR"];
const FEATURED_SLUG = "who-we-are";
